...
import { Loader2, Book, ArrowLeft, Star, Award, Check } from "lucide-react";
...
export default function LessonPage() {
  ...
  // Record lesson completion mutation
          ...
          {isCompleted && (
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Great job finishing this magical lesson. You've earned rewards and unlocked new map areas!
              </p>
