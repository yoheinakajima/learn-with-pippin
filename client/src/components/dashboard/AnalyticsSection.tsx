    ...
    <div className="mt-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-4">
          <h4 className="text-lg font-medium mb-4">Weekly Engagement</h4>
        ...
        {/* Subject Progress */}
        <div className="bg-white rounded-xl shadow-md p-4">
          <h4 className="text-lg font-medium mb-4">Subject Progress</h4>
        ...
        {/* Achievements */}
        <div className="bg-white rounded-xl shadow-md p-4">
          <h4 className="text-lg font-medium mb-4">Recent Achievements</h4>
