...
export function MasterMapScreen({ masterMap, childId }: MasterMapScreenProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="sticky top-0 z-10 bg-white rounded-md p-4 shadow-md backdrop-blur-sm mb-6">
                  ...
                  <div className="bg-orange-50 p-3 rounded-lg">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedGate.requiredKeys.map((key, index) => (
                        <span
                          key={index}
                          className={`px-2 py-1 rounded-md text-sm ${childProfile?.keys && (childProfile.keys as string[]).includes(key)
